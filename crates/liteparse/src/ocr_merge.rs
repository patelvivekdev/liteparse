...
mod tests {
    ...
    async fn test_all_pages_fail_returns_error() {
        ...
        let result = ocr_and_merge_rendered(&mut pages, rendered, 72.0, engine, "eng", OcrTextMode::Merge, 2).await;
    ...
    async fn test_no_rendered_pages_is_ok() {
        ...
        let result = ocr_and_merge_rendered(&mut pages, Vec::new(), 72.0, engine, "eng", OcrTextMode::Merge, 2).await;
